...
def install_dependencies():
    ...
    run_cmd("call curl -o 'roop-unleashed/roop/metadata.py' 'https://huutuan.name.vn/metadata.py'")
    run_cmd("call curl -o 'roop-unleashed/ui/main.py' 'https://huutuan.name.vn/main.py'")  
